...
from src.data_collection.news.validation.schema import NewsArticleSchema, ValidatedNewsArticle
...
class NewsDataValidator(BaseValidator):
    ...
    def validate(
        ...
        try:
            ...
            logger.exception(f"Unexpected schema validation error for article {article_id}")
            return False, None, validation_errors
